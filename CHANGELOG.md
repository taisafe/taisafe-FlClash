...
- fix: update GitHub Actions runners (macos-13→macos-15, disable linux arm64)

- chore: bump version to 0.8.92

- feat: complete rebranding to 台安加速器

- - Update macOS app name to 台安加速器
- - Add Traditional Chinese (zh_TW) localization
- - Update Windows branding (CMakeLists, Runner.rc, installer config)
- - Create new Windows ICO icon
- - Remove Android adaptive icon XML (use PNG instead)
- - Change navigation label from 代理 to 線路
- - Add macOS localized InfoPlist.strings for Chinese

- feat: rebrand to Taisafe with new logo and localized names

- - Rename app to 'Taisafe' (English) / '台安加速器' (Chinese)
- - Replace app icons for Android and macOS with new logo
- - Update AndroidManifest.xml to use localized strings
- - Add strings.xml for EN and zh localization
- - Update macOS AppInfo.xcconfig and DMG config
- - Update distribute_options.yaml and setup.dart for new app name
- - Fix login error handling to show error messages to users
- - Enhanced V2Board API error parsing for better feedback

- feat: enhance security with domain obfuscation, fix Android UI and widgets

- - Implement domain obfuscation using AES-256 and Cloudflare Worker proxy
- - Add secure_config.dart for handling encrypted domains
- - Mask subscription URLs in Profiles view
- - Fix Android full-screen status bar overlap (SafeArea)
- - Fix Network Speed widget layout overlap
- - Refine proxy filtering to hide selector groups
- - Fix RegisterAction Riverpod ref disposal issue
- - Update Logout button color
- - Add Cloudflare Worker script

- Fix critical Android bugs: missing native libs, core timeouts, missing Hysteria2 node

- - Fix missing Hysteria2 node by updating User-Agent to Clash.Meta

- - Fix infinite spinner by adding 5s timeout to core calls

- - Fix blocking core init by completing _connectedCompleter early

- - Rebuild native libs for Android

- - Fix package name in Kotlin plugins

- - Enable cleartext traffic globally

- Refine Proxy Page: hide Auto/Fallback, update text, reduce speed test timeout, bump version

- feat: Implement Shop, Order Management, and Auto-Sync Subscription URL

- feat: update theme to soft tech blue (#64B5F6), fix switch and button colors

- feat: enhance dashboard UI, add crisp chat support, optimize account view
